...
[string]$githubProjectUrl = 'https://github.com/CompuMasterGmbH/CompuMaster.Text.Diff/' #must contain trailing slash!
[string]$masterBranchName = "master" #ususally 'master' or 'main'
[string]$assemblyVersionSourceFilePath = ".\CompuMaster.Text.Diff\CompuMaster.Text.Diff.vbproj"
